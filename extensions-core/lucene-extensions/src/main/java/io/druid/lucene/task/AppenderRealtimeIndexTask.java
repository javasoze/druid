...
import io.druid.segment.realtime.plumber.*;
...
public class AppenderRealtimeIndexTask extends AbstractTask
{
    ...
    public TaskStatus run(final TaskToolbox toolbox) throws Exception
    {
        ...
        // NOTE: "same" segment.
        final PlumberSchool plumberSchool = new AppenderatorPlumberSchool(new LuceneAppenderatorFactory(
