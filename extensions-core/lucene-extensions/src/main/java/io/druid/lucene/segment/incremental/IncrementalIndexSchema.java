...
public class IncrementalIndexSchema
{
  ...
  public LuceneAggregatorFactory[] getMetrics()
  {
    return metrics;
  }
  ...
  public static class Builder
  {
    ...
    private LuceneAggregatorFactory[] metrics;
    ...
    public Builder()
    {
      ...
      this.metrics = new LuceneAggregatorFactory[]{};
    }
    ...
    public Builder withMetrics(LuceneAggregatorFactory[] metrics)
    {
      this.metrics = metrics;
      return this;
    }
