...
import io.druid.lucene.segment.*;
...
public abstract class IncrementalIndex<AggregatorType> implements Iterable<Row>, Closeable
{
  ...
  public static LuceneColumnSelectorFactory makeColumnSelectorFactory(
      final LuceneAggregatorFactory agg,
      final Supplier<InputRow> in,
      final boolean deserializeComplexMetrics
  )
  {
    return new LuceneColumnSelectorFactory()
    {
      @Override
      public DimensionSelector makeDimensionSelector(final String dim) {
        ...
        return new DimensionSelector() {
          ...
          public List getValues() {
            Object o = in.get().getRaw(dim);
            return Arrays.asList(o);
          }

          @Override
          public String lookupName(Object id) {
            throw new UnsupportedOperationException();
          }
  ...
  private final LuceneAggregatorFactory[] metrics;
  ...
  )
  {
    ...
    for (LuceneAggregatorFactory metric : metrics) {
  ...
  public LuceneAggregatorFactory[] getMetricAggs()
  {
    return metrics;
  }
  ...
  public static final class MetricDesc
  {
    ...
    public MetricDesc(int index, LuceneAggregatorFactory factory)
    {
      this.index = index;
