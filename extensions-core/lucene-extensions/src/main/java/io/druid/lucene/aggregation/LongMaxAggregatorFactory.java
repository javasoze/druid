...
/**
 */
public class LongMaxAggregatorFactory extends LuceneAggregatorFactory
{
  ...
  public BufferAggregator factorizeBuffered(LuceneColumnSelectorFactory cursor) {
    return new LongMaxBufferAggregator(cursor.makeDimensionSelector(fieldName));
  }

  @Override
  public Aggregator factorize(LuceneColumnSelectorFactory cursor) {
    return new LongMaxAggregator(name, cursor.makeDimensionSelector(fieldName));
  }
