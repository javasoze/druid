...
import io.druid.segment.loading.MMappedQueryableSegmentFactory;
...
public class StorageNodeModule implements Module
{
  ...
  public void configure(Binder binder)
  {
    ...
    binder.bind(QueryableSegmentFactory.class).to(MMappedQueryableSegmentFactory.class).in(LazySingleton.class);
